	...
	public function getTOC() {
		...
		if ( $this->hasTOCItems() ) {
			...
			if ( ezTOC_Option::get( 'show_heading_text' ) ) {
				...
				$html .= '<div class="toc_title_flex">' . PHP_EOL;

				$html .= '<div class="barsIcon"><i class="fas fa-bars fa-3x"></i></div>' . PHP_EOL;
				...
				if ( ezTOC_Option::get( 'visibility' ) ) {
					...
					$html .= '<a class="ez-toc-pull-right ez-toc-btn ez-toc-btn-xs ez-toc-btn-default ez-toc-toggle" style="display: none;">表示する</a>';
